...
// ═════════════════════════════════════════════════════════════════════════════
//
// Kept only for the v1 decompiler and write-back, which are read against what
// this produced and are replaced by their v2 counterparts in turn (#23, #24).
// Nothing outside the package reaches it: `compileAxis` in `../compile.ts` is
// the compiler, and this file is not exported.
//
