// ═════════════════════════════════════════════════════════════════════════════
// The Axis 1 decompiler
// ═════════════════════════════════════════════════════════════════════════════
//
// Kept only for v1 write-back, which writes statements with it and is replaced
// in turn (#24). The decompiler is `../decompile.ts`; this file is not exported.
//
